...
export class QuestionController {
  ...
  async getRandomQuestionWithDifficulty(
    @Param('questionDifficulty') questionDifficulty: String,
    @Payload() data,
  ) {
    console.log('random called');
    const difficulty = data.difficulty;
    return await this.questionService.getRandomQuestionWithDifficulty(
      difficulty,
    );
  }
