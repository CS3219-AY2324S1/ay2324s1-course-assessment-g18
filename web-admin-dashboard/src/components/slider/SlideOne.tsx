      ...
      >
        <div>
          ...
          <div className="absolute text-center font-semibold p-2 bottom-10">
            Customize your learning experience by selecting the difficulty level
            you want to tackle.
          </div>
          <img
            src={blob1}
            className="absolute left-[80px] top-[50px] w-[20px]"
          />
          <img
            src={blob4}
            className="absolute left-[200px] top-[0px] w-[15px]"
          />
          <img
            src={blob2}
            className="absolute left-[200px] top-[150px] w-[20px]"
          />
          <img
            src={blob3}
            className="absolute left-[310px] top-[80px] w-[20px]"
          />
          <img
            src={blob4}
            className="absolute left-[50px] top-[250px] w-[15px]"
          />
        </div>
      </motion.div>
    </AnimatePresence>
